package ru.mirea.udalovna.intentfilter
...
class MainActivity : AppCompatActivity() {
    ...
    private fun shareStudentInfo() {
        ...
        shareIntent.putExtra(Intent.EXTRA_TEXT, "Удалов Николай\nМИРЭА")
        startActivity(Intent.createChooser(shareIntent, "Удалов Николай Алексеевич"))
    }
