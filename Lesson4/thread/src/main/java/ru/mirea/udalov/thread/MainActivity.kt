package ru.mirea.udalov.thread
...
import ru.mirea.udalov.thread.databinding.ActivityMainBinding
...
class MainActivity : AppCompatActivity() {
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        mainThread.name = "МОЙ НОМЕР ГРУППЫ: 11, НОМЕР ПО СПИСКУ: 26, МОЙ ЛЮБИИМЫЙ ФИЛЬМ:Аватар"
