...
import ru.mirea.udalov.mireaproject.databinding.FragmentMapsBinding
    ...
    companion object {
        ...
        private val PLACES = arrayOf(
            Place(
                ...
                address = "Москва, Южнобутовская улица, д. 78",
                location = GeoPoint(55.538519, 37.532753),
            ),
            Place(
                title = "Красная площадь",
                address = "Москва, ул. Красная площадь",
                location = GeoPoint(55.753544, 37.621202),
            ),
            Place(
                title = "Пироговка",
            ...
            Place(
                title = "Дом",
                address = "Домашний",
                location = GeoPoint(55.669534, 37.481954),
            ),
            Place(
                title = "Крутой дом",
                address = "Какой-то дом",
                location = GeoPoint(55.670676, 37.476842),
            ),
        )
    }
