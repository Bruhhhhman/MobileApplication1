...
import ru.mirea.udalov.employeedb.App
import ru.mirea.udalov.employeedb.Employee
import ru.mirea.udalov.employeedb.databinding.ActivityMainBinding
...
//        employee.id = 1
//        employee.name = "Удалов Николай"
//        employee.salary = 10000
//        employeeDao?.insert(employee)
//
//        employee = Employee()
//        employee.id = 2
//        employee.name = "Павел Бабитский"
//        employee.salary = 128050
//        employeeDao?.insert(employee)
//
//        employee = Employee()
//        employee.id = 3
//        employee.name = "Владимир Лафанов"
